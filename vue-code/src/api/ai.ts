...
// 获取指定 AI 服务的模型列表
export function getAIModels(data: AIProviderRequest): Promise<Response> {
...
// 测试指定 AI 服务连接
export function testAIConnection(data: AIProviderRequest): Promise<Response> {
  return fetch('/ai/test', {
    method: 'POST',
    headers: authHeaders(),
    body: JSON.stringify(data)
  })
