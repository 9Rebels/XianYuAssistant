...
public class XianyuApiUtils {
    ...
    public static Map<String, String> buildStandardParams(String apiName, String timestamp, String sign, String version) {
    ...
    public static String callApi(String apiName, Map<String, Object> dataMap, String cookiesStr,
        ...
        return callApi(apiName, dataMap, cookiesStr, spmCnt, spmPre, "1.0");
    }
    ...
    public static String callApi(String apiName, Map<String, Object> dataMap, String cookiesStr,
        ...
        try {
            ...
            // 5. 构建URL参数
            Map<String, String> params = buildStandardParams(apiName, timestamp, sign, version);
            ...
            // 7. 构建完整URL
            String url = buildUrl(apiName, params, version);
    ...
    public static ApiCallResultWithHeaders callApiWithHeaders(String apiName, Map<String, Object> dataMap, String cookiesStr,
                                                               String spmCnt, String spmPre) {
        return callApiWithHeaders(apiName, dataMap, cookiesStr, spmCnt, spmPre, "1.0");
    }
    ...
    private static String buildUrl(String apiName, Map<String, String> params) {
        return buildUrl(apiName, params, "1.0");
    }

    private static String buildUrl(String apiName, Map<String, String> params, String version) {
