...
public class SessionCookieJar implements CookieJar {
    ...
    public OkHttpClient createHttpClient(java.net.Proxy proxy, okhttp3.Authenticator proxyAuthenticator) {
        ...
        if (proxy != null && proxy != java.net.Proxy.NO_PROXY) {
            builder.proxy(proxy);
            if (proxyAuthenticator != null && proxyAuthenticator != okhttp3.Authenticator.NONE) {
