...
public interface AutoDeliveryService {
     ...
     * 手动回库 API 发货记录
     */
    ResultObject<String> manualReturnApiDelivery(ManualReturnApiDeliveryReqDTO reqDTO);
     ...
     */
    default void executeDelivery(Long recordId, Long accountId, String xyGoodsId, String sId, String orderId, String buyerUserName, boolean needHumanLikeDelay) {
     ...
     * 执行自动发货（支持购买数量）
     */
    void executeDelivery(Long recordId, Long accountId, String xyGoodsId, String sId, String orderId, String buyerUserName, boolean needHumanLikeDelay, int buyQuantity);

    /**
     * 订单取消、关闭或退款时，对API发货做回库补偿。
     */
    void returnApiDeliveryForOrder(Long accountId, String orderId, String reason);
