...
public class SentMessageSaveServiceImpl implements SentMessageSaveService {
    ...
    /** 关键词自动回复 contentType */
    private static final int CONTENT_TYPE_KEYWORD_REPLY = 887;

    /** 自动回复图片 contentType */
    private static final int CONTENT_TYPE_AUTO_IMAGE_REPLY = 886;
    ...
    @Override
    @Async
    public void saveKeywordReply(Long accountId, String cid, String toId, String text, String xyGoodsId) {
        saveSentMessage(accountId, cid, toId, text, CONTENT_TYPE_KEYWORD_REPLY, "关键词回复", xyGoodsId);
    }
    ...
    @Override
    @Async
    public void saveAutoImageReply(Long accountId, String cid, String toId, String imageUrl, String xyGoodsId) {
        saveSentMessage(accountId, cid, toId, "[图片]" + imageUrl, CONTENT_TYPE_AUTO_IMAGE_REPLY, "自动图片回复", xyGoodsId);
    }
    ...
    private void saveSentMessage(Long accountId, String cid, String toId, String text, 
        ...
        try {
            ...
            if (result > 0) {
                readStateService.markOutgoingUnread(accountId, sId, message.getMessageTime());
