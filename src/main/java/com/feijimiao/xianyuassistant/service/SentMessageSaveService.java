...
public interface SentMessageSaveService {
     ...
     * @param xyGoodsId 闲鱼商品ID
     */
    void saveKeywordReply(Long accountId, String cid, String toId, String text, String xyGoodsId);
     ...
     * @param xyGoodsId 闲鱼商品ID
     */
    void saveAutoImageReply(Long accountId, String cid, String toId, String imageUrl, String xyGoodsId);
}
